...
public class ModItems {
    ...
    public static final RegistryObject<Item> SHIT = ITEMS.register("shit", () -> new Item(new Item.Properties().food(ModFoods.SHIT))); //定义食物：一坨Shit
    ...
    /*public static final RegistryObject<ForgeSpawnEggItem> SI_CHUAN_FEN_DA_EGG = ITEMS.register(
            ...
            () -> new ForgeSpawnEggItem(
                    ModEntities.SI_CHUAN_FEN_DA_ENTITY,
                    0xFFFFFF, 0x000000,
                    new Item.Properties()
            )
    ); //定义刷怪蛋：四川芬达刷怪蛋*/
